...
public class AnimalController {
    ...
    @GetMapping
    public List<Animal> getAllAnimals(@RequestParam(required = false) Double minCurrentSatiety, @RequestParam(required = false) Double maxCurrentSatiety,
        ...
        return animalService.getAllAnimals(minCurrentSatiety, maxCurrentSatiety, minFullSatiety, maxFullSatiety, order);
    }
    ...
    public List<Bear> getAllBears(@RequestParam(required = false) Double minCurrentSatiety, @RequestParam(required = false) Double maxCurrentSatiety,
                                  @RequestParam(required = false) Double minFullSatiety, @RequestParam(required = false) Double maxFullSatiety,
                                  @RequestParam(required = false) AnimalsOrder order){
        return animalService.getAllBears(minCurrentSatiety, maxCurrentSatiety, minFullSatiety, maxFullSatiety, order);
    }
    ...
    public List<Lion> getAllLions(@RequestParam(required = false) Double minCurrentSatiety, @RequestParam(required = false) Double maxCurrentSatiety,
                                  @RequestParam(required = false) Double minFullSatiety, @RequestParam(required = false) Double maxFullSatiety,
                                  @RequestParam(required = false) AnimalsOrder order) {
        return animalService.getAllLions(minCurrentSatiety, maxCurrentSatiety, minFullSatiety, maxFullSatiety, order);
    }
    ...
    public List<Tiger> getAllTigers(@RequestParam(required = false) Double minCurrentSatiety, @RequestParam(required = false) Double maxCurrentSatiety,
                                    @RequestParam(required = false) Double minFullSatiety, @RequestParam(required = false) Double maxFullSatiety,
                                    @RequestParam(required = false) AnimalsOrder order){
        return animalService.getAllTigers(minCurrentSatiety, maxCurrentSatiety, minFullSatiety, maxFullSatiety, order);
    }
